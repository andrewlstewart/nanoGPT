...
from src.nanoGPT.model import BigramLanguageModel
...
def main(cfg: DictConfig) -> int:
    ...
    model = BigramLanguageModel(vocab_size=len(tokenizer.valid_chars), learning_rate=cfg.training.learning_rate)
